...
async function getSkillCheck(skill, actor) {
    ...
    const action = game.shadowrun5e.data.actionRollData({skill: skill, attribute: pcSkill.attribute, modifiers: ['global', 'wounds'], test: 'SuccessTest', threshold: threshold, limit: pcLimit});
    return action;
}
